...
Project{
    ...
    ofApp {
        ...
        files: [
            ...
            'src/ofApp.cpp',
            'src/ofApp.h',
            'src/DynamicLibs/DynamicLibs.h',
            'src/DynamicLibs/DynamicLibs.cpp',
            'src/DynamicLibs/MyLibs.h',
            'src/DynamicLibs/Interfaces/GenericInterface.h',
            'src/DynamicLibs/Interfaces/CameraInterface.h',
            'src/DynamicLibs/Libs/Stuff.cpp',
            'src/DynamicLibs/Libs/Camera.cpp',
        ]
